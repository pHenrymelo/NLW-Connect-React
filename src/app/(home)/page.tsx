  ...
  return (
    ...
    >
      <div className=" flex flex-col gap-8 items-center md:items-start">
        ...
        <h1 className=" flex flex-col text-4xl font-heading text-center leading-none font-medium md:text-7xl md:text-left">
    ...
    <div className=" flex flex-col gap-5 items-stretch md:flex-row">
        ...
        <div className=" flex-1 bg-gray-700 border-gray-600 rounded-2xl p-8 space-y-6">
          ...
          >
            <h2
            className=" font-heading font-semibold text-xl text-gray-200"
            >Sobre o evento</h2>
            <span 
